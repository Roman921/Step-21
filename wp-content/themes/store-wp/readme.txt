...
* Theme options was built using Options Framework (http://wptheming.com/options-framework-plugin) that is licensed under the GPL license.
* ThemIcon icon font are based on ElegantIcon (http://www.elegantthemes.com/blog/resources/elegant-icon-font) licensed under the MIT/GPL2 license.
* Nivo Lightbox, copyright 2013 Dev7studios, licensed under MIT license, source: http://dev7studios.com/nivo-lightbox
* OwlCarousel, copyright 2013 Bartosz Wojciechowski, licensed under MIT license, source: http://www.owlgraphic.com/owlcarousel/
* HTML5 Shiv, copyright 2014 Alexander Farkas licensed under the MIT/GPL2 License, source: https://github.com/aFarkas/html5shiv/
* CSS3 mediaqueries js, licensed under the MIT license, source: https://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js
* Screenshot: WooCommerce Sample Data https://github.com/woothemes/woocommerce/blob/master/dummy-data/dummy-data.xml
